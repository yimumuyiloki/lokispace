...
class Gameboard {
  ...
  init() {
    this.circles = [
      new Circle(ctx, 100, 100, 100, 12, 25),
      new Circle(ctx, 60, 180, 130, 180, -275, 20, 0.5),
      new Circle(ctx, 120, 100, 120, 120, 262, 100, 0.3),
      new Circle(ctx, 150, 180, 130, -130, 138, 10, 0.7),
      new Circle(ctx, 190, 210, 130, 138, -280, 10, 0.7),
      new Circle(ctx, 220, 240, 130, 142, 350, 10, 0.7),
    ];
